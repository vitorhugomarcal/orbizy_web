...
export const getEstimateByEstimateIdSuspenseQueryKey = (estimateId: GetEstimateByEstimateIdPathParams['estimateId']) =>
  [{ url: '/estimate/:estimateId', params: { estimateId: estimateId } }] as const

export type GetEstimateByEstimateIdSuspenseQueryKey = ReturnType<typeof getEstimateByEstimateIdSuspenseQueryKey>
...
>(
  ...
  const queryKey = queryOptions?.queryKey ?? getEstimateByEstimateIdSuspenseQueryKey(estimateId)

  const query = useSuspenseQuery({
    ...(getEstimateByEstimateIdSuspenseQueryOptions(estimateId, config) as unknown as UseSuspenseQueryOptions),
    queryKey,
    ...(queryOptions as unknown as Omit<UseSuspenseQueryOptions, 'queryKey'>),
  }) as UseSuspenseQueryResult<TData, ResponseErrorConfig<GetEstimateByEstimateId401 | GetEstimateByEstimateId404>> & { queryKey: TQueryKey }
