...
export function useGetCompanySuspense<
  ...
  TQueryData = GetCompanyQueryResponse,
  TQueryKey extends QueryKey = GetCompanySuspenseQueryKey,
>(
  options: {
    query?: Partial<UseSuspenseQueryOptions<GetCompanyQueryResponse, ResponseErrorConfig<GetCompany400 | GetCompany401>, TData, TQueryKey>>
  ...
  }) as UseSuspenseQueryResult<TData, ResponseErrorConfig<GetCompany400 | GetCompany401>> & { queryKey: TQueryKey }
